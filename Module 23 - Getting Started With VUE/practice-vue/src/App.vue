   ...
   <section>
        ...
        <section class="content">
            <section class="person">
              <img :src="img1.image" :alt="img1.name" :title="img1.name">
                <div>
                    <h1>{{ img1.name }}</h1>
                    <h2>{{ img1.designation }}</h2>
                    <p>{{ img1.location }}</p>
                </div>
            </section>
            <section class="person"><img :src="img2.image" :alt="img2.name" :title="img2.name">
                <div>
                    <h1>{{ img2.name }}</h1>
                    <h2>{{ img2.designation }}</h2>
                    <p>{{ img2.location }}</p>
                </div>
            </section>
            <section class="person"><img :src="img3.image" :alt="img3.name" :title="img3.name">
                <div>
                    <h1>{{ img3.name }}</h1>
                    <h2>{{ img3.designation }}</h2>
                    <p>{{ img3.location }}</p>
                </div>
            </section>
        </section>
